...
export const config = {
  ...
  lyricsDelivery: String(process.env.LYRICS_DELIVERY ?? 'voice_chat_message').trim().toLowerCase(),
  lyricsRequireVoiceChatMessage: toBool(process.env.LYRICS_REQUIRE_VOICE_CHAT_MESSAGE ?? 'true', true),
  lyricsAllowGroupFallback: toBool(process.env.LYRICS_ALLOW_GROUP_FALLBACK ?? 'false', false),
  lyricsVoiceChatUnsupportedBackoffMs: finiteNumber(process.env.LYRICS_VOICE_CHAT_UNSUPPORTED_BACKOFF_MS, 600000),
  lyricsTryVoiceChatMessage: toBool(process.env.LYRICS_TRY_VOICE_CHAT_MESSAGE, false),
  lyricsAssistantFallbackToGroup: toBool(process.env.LYRICS_ASSISTANT_FALLBACK_TO_GROUP, true),
