...
export const config = {
  ...
  // Lyrics delivery is always bot message; assistant/voice-chat-message delivery was removed.
  // LYRICS_DELIVERY, LYRICS_REQUIRE_VOICE_CHAT_MESSAGE, LYRICS_ALLOW_GROUP_FALLBACK, etc. are ignored.
