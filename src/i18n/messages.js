export const translations = {
  en: {
    ...
    lyrics: {
      ...
      providerTimeout: 'Lyrics provider timed out. Please try refreshing again.',
      providerError: 'Provider lirik sedang bermasalah. Coba lagi nanti.',
      providerRateLimited: 'Lyrics provider is rate limited. Trying fallback...',
      providerFallback: 'Trying alternative lyrics source...',
      foundFromProvider: 'Lyrics found from {provider}.',
      plainOnlyNoSync: 'Only plain lyrics are available, no synchronized lyrics.',
      closed: 'Closed.',
...
const aliases = {
  id: {
    ...
    lyrics: {
      ...
      providerTimeout: 'Provider lirik timeout. Coba Refresh lagi.',
      providerError: 'Provider lirik sedang bermasalah. Coba lagi nanti.',
      providerRateLimited: 'Provider lirik sedang rate limit. Mencoba fallback...',
      providerFallback: 'Mencoba sumber lirik lain...',
      foundFromProvider: 'Lirik ditemukan dari {provider}.',
      plainOnlyNoSync: 'Hanya lirik biasa yang tersedia, tidak ada lirik sinkron.',
      closed: 'Ditutup.',
